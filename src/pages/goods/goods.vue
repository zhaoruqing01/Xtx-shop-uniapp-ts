...
<template>
      ...
      <view class="goods">
        ...
        <view class="preview">
          <swiper circular @change="onChange">
            <swiper-item v-for="item in goodsDetailData?.mainPictures" :key="item" @tap="checkImg">
  ...
  <uni-popup ref="popup" type="top" background-color="#fff">
    <AddressHandle v-if="popupName === 'address'"></AddressHandle>
    <ServerPanel v-if="popupName === 'server'"></ServerPanel>
  </uni-popup>
</template>
