...
import { getCartAPI } from '@/services/category'
...
// 二级分类的数据
const subCateData = ref<CategoryChildItem[]>([])
...
onLoad(async () => {
  ...
  await Promise.all([getCateannerData(), getCartData()])
  isLoading.value = false
})
</script>

<template>
  <CateSkeleton v-if="isLoading"></CateSkeleton>
  <view class="viewport" v-else>
    ...
    <view class="categories">
      ...
      <scroll-view class="secondary" scroll-y>
        ...
        <!-- 内容区域 -->
        <view class="panel" v-for="item in subCateData" :key="item.id">
          <view class="title">
            <text class="name">{{ item.name }}</text>
